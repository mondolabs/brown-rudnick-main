<?php
/**
 * Template part for custom footer nav for homepage
 *
 */
?>
...
<div class="social-icons">
 <a href="https://www.facebook.com/Brown-Rudnick-LLP-283665665070333/" target="_blank">
 	<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 21.31 46.17"><title>facebook</title><g id="Layer_2" data-name="Layer 2"><g id="Layer_1-2" data-name="Layer 1"><path d="M4.83,46.17h9.3V22.89h6.49l.69-7.79H14.13V10.65c0-1.84.37-2.57,2.15-2.57h5V0H14.87C8,0,4.83,3,4.83,8.88v6.21H0V23H4.83Z"/></g></g></svg>
 </a>
 <a href="https://twitter.com/brownrudnickllp" target="_blank">
 ...
 <a href="http://www.brownrudnick.com/rss-feeds" target="_blank">
