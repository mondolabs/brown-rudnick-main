...
$data['law_firm_netwrok_header_text'] = get_field('law_firm_netwrok_header_text');
$data['law_firm_netwrok_sidebar_header'] = get_field('law_firm_netwrok_sidebar_header');
$data['law_firm_netwrok_sidebar_items'] = get_field('law_firm_netwrok_sidebar_items');
